...
import blogPageInitialPropsTqGsResource from '../../resources/blog-page-initial-props-tq_gs'
import blogPageInitialPathsTqJResource from '../../resources/blog-page-initial-paths-tq_-j'
...
export async function getStaticProps(context) {
  try {
    const response = await blogPageInitialPropsTqGsResource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await blogPageInitialPathsTqJResource({
