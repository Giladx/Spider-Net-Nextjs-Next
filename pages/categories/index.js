...
import categoriesPageInitialPropsTqPUResource from '../../resources/categories-page-initial-props-tq_p-u'
...
export async function getStaticProps(context) {
  try {
    const response = await categoriesPageInitialPropsTqPUResource({
      ...context?.params,
    })
    if (!response) {
      return {
