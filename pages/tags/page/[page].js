...
import tagsPageInitialPropsTq6cResource from '../../../resources/tags-page-initial-props-tq_6c'
import tagsPageInitialPathsTqGBResource from '../../../resources/tags-page-initial-paths-tq_g-b'
...
export async function getStaticProps(context) {
  try {
    const response = await tagsPageInitialPropsTq6cResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await tagsPageInitialPathsTqGBResource({
      content_type: 'tag',
    })
